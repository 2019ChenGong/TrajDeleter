...
def main(args):
    ...
    for instance in train_episodes_standard:    
        ...
        # print(f"flag:{Flag}")
    print(f"remaining:{(training_account_exact * 1.0) / len(train_episodes_standard)}")
    ...
    print(f"unlearning:{(unlearning_account_exact * 1.0) / len(unlearning_episodes)}")
